...
{
    //std::cout << "this is triu flag1" << std::endl;
    ...
    //std::cout << "this is triu flag2-" << *ptr <<std::endl;
    ...
    */
    ...
    uint32_t dimnum = context->GetInputShape(0)->GetStorageShape().GetDimNum();
    //std::cout << "this is triu flag2-" << dimnum <<std::endl;
    int32_t dimnuma = context->GetInputShape(0)->GetStorageShape().GetDim(dimnum - 2);
    int32_t dimnumb = context->GetInputShape(0)->GetStorageShape().GetDim(dimnum - 1);
    std::cout << "dimnuma:" << dimnuma <<std::endl;
    std::cout << "dimnumb:" << dimnumb <<std::endl;
    int32_t dimnumbalign = dimnumb + (dimnumb % ALIGN_NUM ? ALIGN_NUM - dimnumb % ALIGN_NUM : 0);
